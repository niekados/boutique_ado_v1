...
/*
Summary of whats going on here in Handle for submit:
...
form.addEventListener('submit', function(ev) {
    ev.preventDefault();
    card.update({ 'disabled': true}); // We'll want to disable both the card element and the submit button to prevent multiple submissions.
